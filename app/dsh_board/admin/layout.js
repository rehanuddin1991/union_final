  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-gradient-to-br from-gray-100 to-gray-200">
      ...
      <aside
        ...
        } md:block w-64 bg-gradient-to-b from-blue-900 to-blue-700 text-white p-6 space-y-6 shadow-2xl rounded-r-2xl md:relative fixed top-0 left-0 h-full z-50`}
      >
        ...
        <nav className="space-y-3">
          <a href="/dsh_board/admin" className="block py-2 rounded-lg hover:bg-green-600 transition-all duration-300">
            🏠 Dashboard
          </a>
          ...
          <div className="space-y-1">
            ...
            <div className="ml-4 space-y-1 text-sm">
              <a href="/dsh_board/admin/new-user-creation" className="block py-2 rounded-lg hover:bg-green-600 transition-all duration-300">
                🧾 User Management
              </a>
            </div>
          </div>

          <a href="/dsh_board/admin/employees" className="block py-2 rounded-lg hover:bg-green-600 transition-all duration-300">
            👷‍♂️ Employee Management
          </a>

          <a href="/dsh_board/admin/holding_information" className="block py-2 rounded-lg hover:bg-green-600 transition-all duration-300">
            📋 Holding Tax Information
          </a>

          <a href="/dsh_board/admin/holding_collection" className="block py-2 rounded-lg hover:bg-green-600 transition-all duration-300">
          ...
          <a href="/dsh_board/admin/institutions" className="block py-2 rounded-lg hover:bg-green-600 transition-all duration-300">
            ⚙️ সব প্রতিষ্ঠানের তথ্য
          </a>

          <a href="/dsh_board/admin/masterrole" className="block py-2 rounded-lg hover:bg-green-600 transition-all duration-300">
            🤲 মাস্টাররোল তৈরি
          </a>
          ...
          <a href="/dsh_board/admin/projects" className="block py-2 rounded-lg hover:bg-green-600 transition-all duration-300">
            📁 প্রকল্প ব্যবস্থাপনা
