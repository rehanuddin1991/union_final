    ...
    <div className="flex flex-col md:flex-row min-h-screen bg-gradient-to-br from-gray-100 to-gray-200">
      ...
      >
        ...
        <nav className="space-y-3">
          <a href="/dsh_board/user" className="block py-2 rounded-lg hover:bg-green-600 transition-all duration-300">
            🏠 Dashboard
          </a>
          ...
          <a href="/dsh_board/user/holding_information" className="block py-2 rounded-lg hover:bg-green-600 transition-all duration-300">
            📋 Holding Tax Information
          </a>

          <a href="/dsh_board/user/holding_collection" className="block py-2 rounded-lg hover:bg-green-600 transition-all duration-300">
          ...
          <a href="/dsh_board/user/institutions" className="block py-2 rounded-lg hover:bg-green-600 transition-all duration-300">
            ⚙️ সব প্রতিষ্ঠানের তথ্য
          </a>

          <a href="/dsh_board/user/masterrole" className="block py-2 rounded-lg hover:bg-green-600 transition-all duration-300">
            🤲 মাস্টাররোল তৈরি
          </a>

          <a href="/dsh_board/user/poor" className="block py-2 rounded-lg hover:bg-green-600 transition-all duration-300">
            🤲 হতদরিদ্রের তালিকা
          </a>
